...
param (
    ...
    $printerHost = "192.168.29.220",
    $printerName = "BPM Printer"
)
#endregion
...
$MaxAgeLogFiles = 30
#Driver Vars
$driverUrl = "https://file-transfer.co.uk/bitc/DRIVERS_AND_FIRMWARE/LJE87640-50-60_V3_DriveronlyWebpack_49.3.4469.zip"
$tempPath = "C:\temp\"
$driverZip = $tempPath + "hp.zip"
$driverPath = $tempPath + "hp\"
$infPath = $driverPath + ".inf"
$driverName = "HP Color MFP E87640-50-60"
